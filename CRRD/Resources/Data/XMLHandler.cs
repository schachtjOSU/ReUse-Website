...
namespace CRRD.Resources.Data
{
    class XMLHandler
    {
        ...
        private string BUSINESS_LIST_URI = "http://10.0.2.2/Corvallis-Sustainability-ReUse/public_html/index.php/reuseDB"; // Copied from Resource.String.APIBusinessURI
